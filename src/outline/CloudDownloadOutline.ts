...
const CloudDownloadOutline: IconDefinition = {
  name: 'cloud-download',
  theme: 'outline',
  nameWithTheme: 'cloud-download-o',
  tag: 'svg',
  attrs: {
  ...
  children: [
    {
      ...
      attrs: {
        d:
          'M624 706.3h-74.1V464c0-4.4-3.6-8-8-8h-60c-4.4 0-8 3.6-8 8v242.3H400c-6.7 0-10.4 7.7-6.3 12.9l112 141.7c3.2 4.1 9.4 4.1 12.6 0l112-141.7c4.1-5.2.4-12.9-6.3-12.9z'
      },
      children: []
    },
    {
