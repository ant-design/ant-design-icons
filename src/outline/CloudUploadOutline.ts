...
const CloudUploadOutline: IconDefinition = {
  name: 'cloud-upload',
  theme: 'outline',
  nameWithTheme: 'cloud-upload-o',
  tag: 'svg',
  attrs: {
  ...
  children: [
    {
      ...
      attrs: {
        d:
          'M518.3 459c-3.2-4.1-9.4-4.1-12.6 0l-112 141.7c-4.1 5.2-.4 12.9 6.3 12.9h73.9V856c0 4.4 3.6 8 8 8h60c4.4 0 8-3.6 8-8V613.7H624c6.7 0 10.4-7.7 6.3-12.9L518.3 459z'
      },
      children: []
    },
    {
