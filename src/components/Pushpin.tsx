...
const Pushpin: React.SFC<object> = (props: object) => (
  <svg
    fill="currentColor"
  ...
  >
    <path
      d="M474.7 357.8l-24.5 24.5-34.4-3.8c-9.6-1.1-19.3-1.6-28.9-1.6-29 0-57.5 4.8-84.7 14.1-14 4.8-27.4 10.8-40.3 17.9l353.2 353.2c9.4-17.1 16.9-35.2 22.2-54.2 9.2-32.5 11.9-66 8.2-99.7l-3.8-34.4 24.5-24.5 133.7-133.7-191.5-191.5-133.7 133.7z"
      fill="none"
    />
