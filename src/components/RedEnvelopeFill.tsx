...
const RedEnvelopeFill: React.SFC<object> = (props: object) => (
  <svg
    fill="currentColor"
    id="图层_1"
  ...
  >
    <path
      className="st0"
      d="M639.6 458h-47.8c-3.1 0-6 1.8-7.5 4.6l-71.9 141.9-71.9-141.8c-1.4-2.8-4.3-4.6-7.5-4.6h-48.8c-1.3 0-2.6.4-3.9 1-4.1 2.2-5.6 7.3-3.4 11.4l87.4 161.1H419c-4.6 0-8.4 3.8-8.4 8.4v25.1c0 4.6 3.8 8.4 8.4 8.4h63v28.6h-63c-4.6 0-8.4 3.8-8.4 8.4v25.1c0 4.6 3.8 8.4 8.4 8.4h63v49.9c0 4.6 3.8 8.4 8.4 8.4h43.7c4.6 0 8.4-3.8 8.4-8.4V744h63.3c4.7 0 8.4-3.8 8.2-8.5v-25c0-4.6-3.8-8.4-8.4-8.4h-63.3v-28.6h63.3c4.6 0 8.4-3.8 8.4-8.4V640c0-4.6-3.8-8.4-8.4-8.4h-45.9l87.2-161c.7-1.2 1-2.6 1-4 .1-4.8-3.7-8.6-8.3-8.6zM512.6 323L735 148H289z"
    />
