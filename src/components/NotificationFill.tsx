...
const NotificationFill: React.SFC<object> = (props: object) => (
  <svg viewBox="0 0 1024 1024" width="1em" height="1em" {...props}>
    <path
      d="M296 714.5c0 26.4 21.5 47.8 48 47.8 25.2 0 45.9-19.5 47.9-44.1L307 684.1c-7.1 8.5-11 19.2-11 30.4z"
      fill="currentColor"
    />
