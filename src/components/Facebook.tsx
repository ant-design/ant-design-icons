...
const Facebook: React.SFC<object> = (props: object) => (
  <svg viewBox="0 0 1024 1024" width="1em" height="1em" {...props}>
    <path
      d="M176 848h363.2V602.2H434.9V481.4h104.3v-89c0-103.3 63.1-159.6 155.3-159.6 44.2 0 82.1 3.3 93.2 4.8v108h-63.9c-50.1 0-59.8 23.8-59.8 58.8v77.1h119.6L768 602.2H664V848h184V176H176v672z"
      fill="currentColor"
    />
