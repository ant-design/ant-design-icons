...
const VideoFill: React.SFC<object> = (props: object) => (
  <svg
    fill="currentColor"
    id="图层_1"
  ...
  >
    <path
      className="st0"
      d="M784 565.1L888 625V399l-104 59.9zM320 296H208c-4.4 0-8 3.6-8 8v48c0 4.4 3.6 8 8 8h112c4.4 0 8-3.6 8-8v-48c0-4.4-3.6-8-8-8z"
    />
