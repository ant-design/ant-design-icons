...
const Alipay: React.SFC<object> = (props: object) => (
  <svg
    fill="currentColor"
  ...
  >
    <path
      d="M227.6 528.6c-24.2 2.4-69.6 13.1-94.4 35-74.4 64.7-29.9 183.1 120.6 183.1 87.5 0 174.9-55.8 243.6-145.2-97.6-47.7-180.4-81.8-269.8-72.9z"
      fill="none"
    />
