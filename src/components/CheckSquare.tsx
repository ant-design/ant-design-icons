...
const CheckSquare: React.SFC<object> = (props: object) => (
  <svg
    fill="currentColor"
  ...
  >
    <path
      d="M184 840h656V184H184v656zm131-367.8h46.9c10.2 0 19.9 4.9 25.9 13.3l71.2 98.8 157.2-218c6-8.3 15.6-13.3 25.9-13.3H689c6.5 0 10.3 7.4 6.5 12.7l-210.6 292c-12.7 17.7-39 17.7-51.7 0L308.5 484.9c-3.8-5.3 0-12.7 6.5-12.7z"
      fill="none"
    />
