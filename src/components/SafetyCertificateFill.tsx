...
const SafetyCertificateFill: React.SFC<object> = (props: object) => (
  <svg viewBox="0 0 1024 1024" width="1em" height="1em" {...props}>
    <path
      d="M688 328h-55.2c-5.1 0-10 2.5-13 6.6L468.9 542.4l-64.7-89c-3-4.1-7.8-6.6-13-6.6H336c-6.5 0-10.3 7.4-6.5 12.7l126.4 174c6.4 8.8 19.6 8.8 26 0l212.6-292.7c3.8-5.4 0-12.8-6.5-12.8z"
      fill="currentColor"
    />
...
SafetyCertificateFill.displayName = "SafetyCertificateFill";
