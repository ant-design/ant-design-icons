...
const TwitterSquareFill: IconDefinition = {
  name: 'twitter-square',
  theme: 'fill',
  nameWithTheme: 'twitter-square-fill',
  tag: 'svg',
  attrs: {
