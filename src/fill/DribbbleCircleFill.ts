...
const DribbbleCircleFill: IconDefinition = {
  name: 'dribbble-circle',
  theme: 'fill',
  nameWithTheme: 'dribbble-circle-fill',
  tag: 'svg',
  attrs: {
