...
const temp: any = function SnippetsTwoTone(
  primaryColor: string,
  ...
  return {
    name: 'snippets',
    theme: 'twotone',
    nameWithTheme: 'snippets-twotone',
    tag: 'svg',
    attrs: {
...
temp.nameWithTheme = 'snippets-twotone';
const SnippetsTwoTone: IconDefinitionGetter = temp;
