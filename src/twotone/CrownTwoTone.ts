...
const temp: any = function CrownTwoTone(
  primaryColor: string,
  ...
  return {
    ...
    children: [
      ...
      },
      {
        ...
        attrs: {
          d:
            'M188.5 865c1.1 7.9 7.9 14 16 14h615.1c8 0 14.9-6 15.9-14l76.4-580.6v-.5c.3-6.4-6.7-10.8-12.3-7.4L705 396.4 518.4 147.5c-3.2-4.3-9.6-4.3-12.9 0L319 396.4 124.3 276.5c-5.5-3.4-12.6.9-12.2 7.3v.6L188.5 865zm147.8-377.7L512 252.9l175.7 234.4 139.8-86.1-53.9 409.4H250.3l-53.8-409.4 139.8 86.1z',
          fill: primaryColor
        },
        children: []
      }
...
temp.nameWithTheme = 'crown-twotone';
const CrownTwoTone: IconDefinitionGetter = temp;
