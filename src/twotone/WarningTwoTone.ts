...
const temp: any = function WarningTwoTone(
  primaryColor: string,
    ...
    children: [
      ...
      },
      {
        ...
        attrs: {
          fill: secondaryColor,
          d:
            'M172.2 828.1h679.6L512 239.9 172.2 828.1zM560 720c0 26.5-21.5 48-48 48s-48-21.5-48-48 21.5-48 48-48 48 21.5 48 48zm-16-304v184c0 4.4-3.6 8-8 8h-48c-4.4 0-8-3.6-8-8V416c0-4.4 3.6-8 8-8h48c4.4 0 8 3.6 8 8z'
        },
        children: []
      },
      {
...
temp.nameWithTheme = 'warning-twotone';
const WarningTwoTone: IconDefinitionGetter = temp;
