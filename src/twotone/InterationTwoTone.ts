...
const temp: any = function InterationTwoTone(
  primaryColor: string,
  ...
  return {
    name: 'interation',
    theme: 'twotone',
    nameWithTheme: 'interation-twotone',
    tag: 'svg',
    attrs: {
...
temp.nameWithTheme = 'interation-twotone';
const InterationTwoTone: IconDefinitionGetter = temp;
