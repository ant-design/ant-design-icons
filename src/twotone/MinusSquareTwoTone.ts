...
const temp: any = function MinusSquareTwoTone(
  primaryColor: string,
  ...
  return {
    name: 'minus-square',
    theme: 'twotone',
    nameWithTheme: 'minus-square-twotone',
    tag: 'svg',
    attrs: {
...
temp.nameWithTheme = 'minus-square-twotone';
const MinusSquareTwoTone: IconDefinitionGetter = temp;
