...
const temp: any = function FileAddTwoTone(
  primaryColor: string,
  ...
  return {
    name: 'file-add',
    theme: 'twotone',
    nameWithTheme: 'file-add-twotone',
    tag: 'svg',
    attrs: {
    ...
    children: [
      {
        ...
        attrs: {
          fill: secondaryColor,
          d:
            'M534 352V136H232v752h560V394H576c-23.2 0-42-18.8-42-42zm126 236v48c0 4.4-3.6 8-8 8H544v108c0 4.4-3.6 8-8 8h-48c-4.4 0-8-3.6-8-8V644H372c-4.4 0-8-3.6-8-8v-48c0-4.4 3.6-8 8-8h108V472c0-4.4 3.6-8 8-8h48c4.4 0 8 3.6 8 8v108h108c4.4 0 8 3.6 8 8z'
        },
        children: []
      },
      {
...
temp.nameWithTheme = 'file-add-twotone';
const FileAddTwoTone: IconDefinitionGetter = temp;
