...
const temp: any = function AlertTwoTone(
  primaryColor: string,
...
temp.nameWithTheme = 'alert-twotone';
const AlertTwoTone: IconDefinitionGetter = temp;
