...
const temp: any = function CameraTwoTone(
  primaryColor: string,
...
temp.nameWithTheme = 'camera-twotone';
const CameraTwoTone: IconDefinitionGetter = temp;
