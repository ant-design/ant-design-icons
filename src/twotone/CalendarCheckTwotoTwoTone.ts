...
const temp: any = function CalendarCheckTwotoTwoTone(
  primaryColor: string,
  secondaryColor: string
) {
  return {
    name: 'calendar-check-twoto',
    theme: 'twotone',
    nameWithTheme: 'calendar-check-twoto-twotone',
    tag: 'svg',
    attrs: {
    ...
    children: [
      ...
      },
      {
        ...
        attrs: {
          d:
            'M724.2 454.6L620.6 598.3l-52.8-73.1c-3-4.2-7.8-6.6-12.9-6.6H500c-6.5 0-10.3 7.4-6.5 12.7l114.1 158.2c6.4 8.8 19.4 8.8 25.8 0l165-228.7c3.8-5.3 0-12.7-6.5-12.7H737c-5-.1-9.8 2.4-12.8 6.5zM416 496H232c-4.4 0-8 3.6-8 8v48c0 4.4 3.6 8 8 8h184c4.4 0 8-3.6 8-8v-48c0-4.4-3.6-8-8-8z',
          fill: primaryColor
        },
        children: []
      },
...
temp.nameWithTheme = 'calendar-check-twoto-twotone';
const CalendarCheckTwotoTwoTone: IconDefinitionGetter = temp;
export default CalendarCheckTwotoTwoTone;
