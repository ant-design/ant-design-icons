...
const temp: any = function TrademarkCircleTwoTwoTone(
  primaryColor: string,
  secondaryColor: string
) {
  return {
    name: 'trademark-circle-two',
    theme: 'twotone',
    nameWithTheme: 'trademark-circle-two-twotone',
    tag: 'svg',
    attrs: {
...
temp.nameWithTheme = 'trademark-circle-two-twotone';
const TrademarkCircleTwoTwoTone: IconDefinitionGetter = temp;
export default TrademarkCircleTwoTwoTone;
