...
const temp: any = function FileTextTwoTone(
  primaryColor: string,
  ...
  return {
    name: 'file-text',
    theme: 'twotone',
    nameWithTheme: 'file-text-twotone',
    tag: 'svg',
    attrs: {
    ...
    children: [
      {
        ...
        attrs: {
          fill: secondaryColor,
          d:
            'M534 352V136H232v752h560V394H576c-23.2 0-42-18.8-42-42zm-22 322c0 4.4-3.6 8-8 8H320c-4.4 0-8-3.6-8-8v-48c0-4.4 3.6-8 8-8h184c4.4 0 8 3.6 8 8v48zm200-184v48c0 4.4-3.6 8-8 8H320c-4.4 0-8-3.6-8-8v-48c0-4.4 3.6-8 8-8h384c4.4 0 8 3.6 8 8z'
        },
        children: []
      },
      {
...
temp.nameWithTheme = 'file-text-twotone';
const FileTextTwoTone: IconDefinitionGetter = temp;
