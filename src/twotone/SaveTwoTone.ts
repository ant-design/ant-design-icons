...
const temp: any = function SaveTwoTone(
  primaryColor: string,
  ...
  return {
    ...
    children: [
      ...
      },
      {
        ...
        attrs: {
          d:
            'M893.3 293.3L730.7 130.7c-.7-.7-1.4-1.3-2.1-2-.1-.1-.3-.2-.4-.3-.7-.7-1.5-1.3-2.2-1.9-6.5-5.3-14-9.3-22-11.7V112H144c-17.7 0-32 14.3-32 32v736c0 17.7 14.3 32 32 32h736c17.7 0 32-14.3 32-32V338.5c0-17-6.7-33.2-18.7-45.2zM384 184h256v104H384V184zm456 656H184V184h136v136c0 17.7 14.3 32 32 32h320c17.7 0 32-14.3 32-32V205.8l136 136V840z',
          fill: primaryColor
        },
        children: []
      }
...
temp.nameWithTheme = 'save-twotone';
const SaveTwoTone: IconDefinitionGetter = temp;
