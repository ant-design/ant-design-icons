...
const temp: any = function VideoCameraTwoTone(
  primaryColor: string,
  ...
  return {
    name: 'video-camera',
    theme: 'twotone',
    nameWithTheme: 'video-camera-twotone',
    tag: 'svg',
    attrs: {
...
temp.nameWithTheme = 'video-camera-twotone';
const VideoCameraTwoTone: IconDefinitionGetter = temp;
