...
const temp: any = function ReconciliationTwotoTwoTone(
  primaryColor: string,
  secondaryColor: string
) {
  return {
    name: 'reconciliation-twoto',
    theme: 'twotone',
    nameWithTheme: 'reconciliation-twoto-twotone',
    tag: 'svg',
    attrs: {
...
temp.nameWithTheme = 'reconciliation-twoto-twotone';
const ReconciliationTwotoTwoTone: IconDefinitionGetter = temp;
export default ReconciliationTwotoTwoTone;
