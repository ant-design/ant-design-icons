...
const temp: any = function PlusCircleTwoTone(
  primaryColor: string,
  ...
  return {
    name: 'plus-circle',
    theme: 'twotone',
    nameWithTheme: 'plus-circle-twotone',
    tag: 'svg',
    attrs: {
...
temp.nameWithTheme = 'plus-circle-twotone';
const PlusCircleTwoTone: IconDefinitionGetter = temp;
