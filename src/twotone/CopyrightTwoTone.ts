...
const temp: any = function CopyrightTwoTone(
  primaryColor: string,
  ...
  return {
    name: 'copyright',
    theme: 'twotone',
    nameWithTheme: 'copyright-twotone',
    tag: 'svg',
    attrs: {
...
temp.nameWithTheme = 'copyright-twotone';
const CopyrightTwoTone: IconDefinitionGetter = temp;
