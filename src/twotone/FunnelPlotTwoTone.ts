...
const temp: any = function FunnelPlotTwoTone(
  primaryColor: string,
  ...
  return {
    name: 'funnel-plot',
    theme: 'twotone',
    nameWithTheme: 'funnel-plot-twotone',
    tag: 'svg',
    attrs: {
...
temp.nameWithTheme = 'funnel-plot-twotone';
const FunnelPlotTwoTone: IconDefinitionGetter = temp;
