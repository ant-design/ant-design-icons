...
const temp: any = function NotificationTwoTone(
  primaryColor: string,
  ...
  return {
    name: 'notification',
    theme: 'twotone',
    nameWithTheme: 'notification-twotone',
    tag: 'svg',
    attrs: {
...
temp.nameWithTheme = 'notification-twotone';
const NotificationTwoTone: IconDefinitionGetter = temp;
