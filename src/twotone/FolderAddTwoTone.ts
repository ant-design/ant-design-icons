...
const temp: any = function FolderAddTwoTone(
  primaryColor: string,
  ...
  return {
    name: 'folder-add',
    theme: 'twotone',
    nameWithTheme: 'folder-add-twotone',
    tag: 'svg',
    attrs: {
...
temp.nameWithTheme = 'folder-add-twotone';
const FolderAddTwoTone: IconDefinitionGetter = temp;
