...
const temp: any = function RightSquareTwoTone(
  primaryColor: string,
  ...
  return {
    name: 'right-square',
    theme: 'twotone',
    nameWithTheme: 'right-square-twotone',
    tag: 'svg',
    attrs: {
...
temp.nameWithTheme = 'right-square-twotone';
const RightSquareTwoTone: IconDefinitionGetter = temp;
