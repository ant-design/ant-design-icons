...
const temp: any = function MinusCircleTwoTone(
  primaryColor: string,
  ...
  return {
    name: 'minus-circle',
    theme: 'twotone',
    nameWithTheme: 'minus-circle-twotone',
    tag: 'svg',
    attrs: {
...
temp.nameWithTheme = 'minus-circle-twotone';
const MinusCircleTwoTone: IconDefinitionGetter = temp;
