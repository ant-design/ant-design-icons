...
const temp: any = function FilePptTwoTone(
  primaryColor: string,
  ...
  return {
    name: 'file-ppt',
    theme: 'twotone',
    nameWithTheme: 'file-ppt-twotone',
    tag: 'svg',
    attrs: {
    ...
    children: [
      ...
      },
      {
        ...
        attrs: {
          fill: secondaryColor,
          d:
            'M534 352V136H232v752h560V394H576c-23.2 0-42-18.8-42-42zm90 218.4c0 55.2-36.8 94.1-96.2 94.1h-63.3V760c0 4.4-3.6 8-8 8H424c-4.4 0-8-3.6-8-8V484c0-4.4 3.6-8 8-8v.1h104c59.7 0 96 39.8 96 94.3z'
        },
        children: []
      },
      {
...
temp.nameWithTheme = 'file-ppt-twotone';
const FilePptTwoTone: IconDefinitionGetter = temp;
