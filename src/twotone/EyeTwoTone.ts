...
const temp: any = function EyeTwoTone(
  primaryColor: string,
    ...
    children: [
      {
        ...
        attrs: {
          fill: secondaryColor,
          d:
            'M81.8 537.8c-7.7-16.3-7.7-35.3 0-51.5C176.6 286.5 319.8 186 512 186c-192.2 0-335.4 100.5-430.2 300.3-7.7 16.2-7.7 35.2 0 51.5C176.6 737.5 319.9 838 512 838c-192.1 0-335.4-100.5-430.2-300.2z'
        },
        children: []
      },
      {
...
temp.nameWithTheme = 'eye-twotone';
const EyeTwoTone: IconDefinitionGetter = temp;
