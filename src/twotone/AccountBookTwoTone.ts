...
const temp: any = function AccountBookTwoTone(
  primaryColor: string,
  ...
  return {
    name: 'account-book',
    theme: 'twotone',
    nameWithTheme: 'account-book-twotone',
    tag: 'svg',
    attrs: {
...
temp.nameWithTheme = 'account-book-twotone';
const AccountBookTwoTone: IconDefinitionGetter = temp;
