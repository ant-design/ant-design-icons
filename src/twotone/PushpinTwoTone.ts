...
const temp: any = function PushpinTwoTone(
  primaryColor: string,
    ...
    children: [
      {
        ...
        attrs: {
          fill: secondaryColor,
          d:
            'M474.8 357.7l-24.5 24.5-34.4-3.8c-9.6-1.1-19.3-1.6-28.9-1.6-29 0-57.5 4.7-84.7 14.1-14 4.8-27.4 10.8-40.3 17.9l353.1 353.3c9.4-17.1 16.8-35.2 22.2-54.2 9.2-32.5 11.9-66 8.2-99.7l-3.8-34.4 24.5-24.5L800 415.5 608.5 224 474.8 357.7z'
        },
        children: []
      },
      {
...
temp.nameWithTheme = 'pushpin-twotone';
const PushpinTwoTone: IconDefinitionGetter = temp;
