...
const temp: any = function ContainerTwoTone(
  primaryColor: string,
  ...
  return {
    name: 'container',
    theme: 'twotone',
    nameWithTheme: 'container-twotone',
    tag: 'svg',
    attrs: {
    ...
    children: [
      {
        ...
        attrs: {
          fill: secondaryColor,
          d:
            'M635 771.7c-34.5 28.6-78.2 44.3-123 44.3s-88.5-15.8-123-44.3c-27.1-22.4-47.5-51.9-59.1-84.7H232v201h560V687h-97.9c-11.6 32.8-32 62.3-59.1 84.7z'
        },
        children: []
      },
      {
...
temp.nameWithTheme = 'container-twotone';
const ContainerTwoTone: IconDefinitionGetter = temp;
