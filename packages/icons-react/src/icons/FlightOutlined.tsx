...
const FlightOutlined = (
  props: AntdIconProps,
  ref: React.MutableRefObject<HTMLSpanElement>,
) => <AntdIcon {...props} ref={ref} icon={FlightOutlinedSvg} />;
...
> = React.forwardRef<HTMLSpanElement, AntdIconProps>(FlightOutlined);

if (process.env.NODE_ENV !== 'production') {
  RefIcon.displayName = 'FlightOutlined';
}
